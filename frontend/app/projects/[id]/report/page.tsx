...
export default function ReportPage() {
  ...
  const finalModelQualityIssueCount = finalModelQuality ? finalModelQuality.status === "warning" ? finalModelQuality.warnings.length : finalModelQuality.blockers.length : 0;
  const finalModelBundle = finalModelQuality?.bundle;
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="glass-panel mt-5 rounded-lg p-8">
          ...
          <section className="mt-8">
            ...
            <section className={`mt-4 rounded-lg border p-5 ${finalModel?.ready ? "border-emerald-300/30 bg-emerald-300/10" : "border-white/10 bg-white/[0.03]"}`}>
